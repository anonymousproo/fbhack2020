...
echo $i" |"$cy"     BANGLADESHI DARK TERMUX ASSOCIATE"$i"         |"
echo $i" |"$me"─────────────────────────────────────────────"$i"|"
echo $i" |"$pu" AUTHOR :"$ku" BANGLATECHNOLOGY [banglatechnology]"$i"          |"
echo $i" |"$pu" FACEBOOK :"$ku" prince mahfuz"$i"                   |"
echo $i" |"$pu" THANKS TO :"$cy"~ [MR.bdt] [MR.hcker] [MR.bt]"$i"  |"
echo $i" |"$cy"            ~ [cyber] [%MR.yt%] [anonymous]"$i" |"
echo $i" |"$pu"   WhatsApp :"$ku" https://bit.ly/2WqTXt3"$i"             |"
echo $i" |"$pu" YTB :"$ku" https://bit.ly/3bAr9CN"$i"      |"
echo $i" |"$pu" YTB :"$ku" https://bit.ly/33XH7nP"$i"      |"
echo $i"["$bi"•"$i"]"$me"───────────────────────────────────────────"$i"["$bi"•"$i"]"
echo
echo $i"────────────────────────────────    ─────"
